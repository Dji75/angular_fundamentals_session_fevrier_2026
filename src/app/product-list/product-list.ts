...
export class ProductList implements OnChanges {
  ...
  protected filteredProduct: Product[] = this.products;

  ngOnChanges(changes: SimpleChanges): void {
    // const newFilterValue = changes['filter'].currentValue;
    // const newFilterValue = this.filter();

    this.filteredProduct = this.filter() === null ? this.products : this.products.filter(p => p.category === this.filter());
  }
}
